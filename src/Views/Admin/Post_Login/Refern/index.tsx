...
//     const text = `Hey! Use my referral code ${referralCode} and get 10% OFF on your subscription!`;
...
//             <span className="font-medium">Share</span> the referral code above. You will{' '}
//             <span className="text-green-600 font-semibold">Earn 10% Papers</span> in your Test Generator subscription and buyers will get{' '}
//             <span className="text-red-500 font-semibold">10% OFF</span> while using your{' '}
...
//               1. <span className="font-semibold">Test Generator:</span>
//             </Text>
//             <Text className="text-gray-600 text-base leading-relaxed ml-4 block mt-1">
...
//           <div>
//             <Text className="text-gray-700 font-medium text-base">
//               2. <span className="font-semibold">Student Subscription:</span>
//             </Text>
//             <Text className="text-gray-600 text-base leading-relaxed ml-4 block mt-1">
//               If your students purchase any subscription in the MyWebName App or website using your coupon code, you will get{' '}
//               <span className="font-semibold">One Paper</span> against each subject purchased. This means if 100 students use your code to buy 3 subjects each, we will credit 300 papers into your account that will be valid till your current package's expiry date.
//             </Text>
//           </div>
//         </div>
//       </Card>
